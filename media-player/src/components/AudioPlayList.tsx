...
const AudioPlayList: React.FC<AudioPlayListProps> = ({ playlist }) => {
    ...
    return (
        <div className="audio-playlist">
            <h3 className="text-3xl font-bold text-center mb-6">Audio Playlist</h3>
            <ul className="mb-6">
            ...
            <audio ref={audioRef} src={playlist[currentTrackIndex].src} className="w-full">
